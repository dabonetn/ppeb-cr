...
Action-Reply (VDPREGS - because recording them was important to the implementation) Print-Screen to save, Win-Menu to restore (Doesn't support SAMS or PCODE).  
